  ...
  return (
    <main className="max-w-4xl mx-auto flex flex-col gap-16 items-center sm:items-start pt-24">
      <div id="introduction" className="text-center sm:text-left space-y-6 backdrop-blur-lg bg-white/40 dark:bg-gray-800/40 p-8 rounded-2xl shadow-xl transform hover:scale-105 transition-all duration-300 w-full">
        <h1 className="text-7xl font-bold bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 bg-clip-text text-transparent animate-gradient">Хендриаман Варуву</h1>
        <h2 className="text-4xl text-gray-700 dark:text-gray-300 font-semibold">Титулованный кинооператор и креативный видеомонтажёр</h2>
        <p className="text-2xl text-gray-600 dark:text-gray-400 font-medium">Превращаем видение в кинематографические шедевры</p>
      </div>

      <div id="about" className="max-w-2xl w-full transform hover:scale-105 transition-all duration-300">
      <h3 className="text-4xl font-bold bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 bg-clip-text text-transparent animate-gradient">Обо мне</h3>
      ...
      <div id="skills" className="flex flex-col gap-8 items-center sm:items-start bg-white/40 dark:bg-gray-800/40 backdrop-blur-lg rounded-2xl p-10 shadow-xl w-full max-w-2xl border border-gray-100 dark:border-gray-700 transform hover:scale-105 transition-all duration-300">
        <h3 className="text-4xl font-bold bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 bg-clip-text text-transparent animate-gradient">Навыки</h3>
        <ul className="grid grid-cols-1 sm:grid-cols-2 gap-6 w-full">
          ...
          <li className="flex items-center gap-3 text-gray-700 dark:text-gray-300 bg-white/30 dark:bg-gray-700/30 p-6 rounded-xl shadow-lg hover:shadow-xl transition-all hover:scale-105">
            <Image src="/cinematography_icon.png" alt="Кинематография" width={32} height={32} className="animate-bounce" />
            Кинематография
          </li>
          <li className="flex items-center gap-3 text-gray-700 dark:text-gray-300 bg-white/30 dark:bg-gray-700/30 p-6 rounded-xl shadow-lg hover:shadow-xl transition-all hover:scale-105">
            <Image src="/color_correction_icon.png" alt="Цветокоррекция" width={32} height={32} className="animate-bounce" />
            Цветокоррекция
          </li>
          <li className="flex items-center gap-3 text-gray-700 dark:text-gray-300 bg-white/30 dark:bg-gray-700/30 p-6 rounded-xl shadow-lg hover:shadow-xl transition-all hover:scale-105">
            <Image src="/audio_processing_icon.png" alt="Обработка звука" width={32} height={32} className="animate-bounce" />
            Обработка звука
          </li>
        </ul>
      </div>
      ...
      <div id="contact" className="flex flex-col gap-8 items-center sm:items-start bg-white/40 dark:bg-gray-800/40 backdrop-blur-lg rounded-2xl p-10 shadow-xl w-full max-w-2xl border border-gray-100 dark:border-gray-700 transform hover:scale-105 transition-all duration-300">
        <h3 className="text-4xl font-bold bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 bg-clip-text text-transparent animate-gradient">Социальные сети</h3>
