...
export default function EnglishPortfolio() {
  return (
    <main className="max-w-6xl mx-auto flex flex-col gap-16 items-center sm:items-start pt-24">
      <div id="introduction" className="text-center sm:text-left space-y-6 backdrop-blur-lg bg-white/40 dark:bg-gray-800/40 p-10 rounded-3xl shadow-2xl transform hover:scale-105 transition-all duration-500 w-full max-w-6xl cursor-default border border-gray-100/50 dark:border-gray-700/50">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-8">
          <div className="space-y-8">
            ...
            <h2 className="text-4xl text-gray-700 dark:text-gray-300 font-bold bg-gradient-to-r from-gray-700 to-gray-900 dark:from-gray-300 dark:to-gray-100 bg-clip-text hover:scale-105 transition-transform">Award-Winning Cinematographer & Creative Video Editor</h2>
            <p className="text-2xl text-gray-600 dark:text-gray-400 font-medium italic hover:text-blue-600 dark:hover:text-blue-400 transition-colors">Transforming Visions into Cinematic Masterpieces</p>
          </div>
          <Image 
            src="/profile.jpg" 
      ...
      <h3 className="text-4xl font-extrabold bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 bg-clip-text text-transparent animate-gradient cursor-default drop-shadow-lg hover:scale-110 transition-transform">About Me</h3>
